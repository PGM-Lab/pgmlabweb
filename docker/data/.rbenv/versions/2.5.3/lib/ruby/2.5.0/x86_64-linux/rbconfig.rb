...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/root/.rbenv/versions/2.5.3")
  ...
  CONFIG["configure_args"] = " '--prefix=/root/.rbenv/versions/2.5.3' 'LDFLAGS=-L/root/.rbenv/versions/2.5.3/lib ' 'CPPFLAGS=-I/root/.rbenv/versions/2.5.3/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/root/.rbenv/versions/2.5.3"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/root/.rbenv/versions/2.5.3/lib  -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/root/.rbenv/versions/2.5.3/include  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/root/.rbenv/versions/2.5.3/lib  -fstack-protector -rdynamic -Wl,-export-dynamic"
